...
function Entity:CarriedObjectMovement()
    if self.thrown == false then
        if self.carriedObject ~= nil then
            self.carriedObject:moveMent(self)
        end
    end
end

function Entity:ObjectThrown(dt)
    if self.thrown then
        if self.carriedObject ~= nil then
            Event.dispatch('objectThrown')
            self.carriedObject:ObjectThrownMovement(self,dt)
        end
    end
end
