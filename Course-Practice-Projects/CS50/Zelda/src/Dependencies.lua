...
require 'src/states/entity/player/PlayerPotLiftWalkState'
...
-- table.slice(tbl, firstfirst, firstlast, secondfirst, secondlast, thirdfirst, thirdlast,step)
gFrames = {
    ...
    ['pot'] = table.slice(GenerateQuads(gTextures['tiles'], 16, 16),14,16,33,35,52,54),
