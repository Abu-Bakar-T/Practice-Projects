...
function Dungeon:init(player)
    ...
    Event.on('potCollided', function()
        self:carriedObjectFinder()
    end)
end
...
function Dungeon:beginShifting(shiftX, shiftY)
    ...
    if self.player.carriedObject ~= nil then
        self.player.thrown = false
        self.player.carriedObject.opacity = 0
        self.player.carriedObject = nil
    end
...
function Dungeon:carriedObjectFinder()
